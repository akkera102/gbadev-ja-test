...
EWRAM_CODE char* MenuGetStr(s32 sel)
{
	...
	if(Menu.type == MENU_TYPE_SYSTEM && sel == 2)
	{
		...
		if(NvGetVar(201) == 1)
		{
			_Strcat(Menu.buf, "Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@ÇlÇP");
		}
		else
		{
			_Strcat(Menu.buf, "Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@ÇlÇO");
		}
		...
		if(NvGetVar(200) == 2)
		{
			...
			_Strcat(Menu.buf, "ÇjÇP");
		}
		else
		{
			_Strcat(Menu.buf, "ÇjÇO");
		}
