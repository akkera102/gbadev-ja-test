...
解析資料はNotequalsoftさんより情報提供して頂きました。具体的にはアーカイブ、スクリプト、画像、音声におけるデコードです。パッと見ただけで数か月か1年以上かかっていると思われる内容でした。出発地点を変えてもらい、とても感謝しています。

- [Hoshi](https://twitter.com/hoshi903)

前回の引き続き、Hoshiさんにゲームボーイサウンドで作って頂きました。最初、どういう風にと考えて「バブル時代のイケイケな感じで」という謎ワードが出てしまったのは今では笑い話です。打ち合わせの度にクオリティがアップしていて、特にエンディングは最高の出来栄えです。GBAは全体的に遅く味付けしたので音楽のbpmを遅くしています。良かったら[音楽ロム](https://github.com/akkera102/gbadev-ja-test/tree/main/126_viper_gts_bgm_test)も用意していますので聞いてみてください。
