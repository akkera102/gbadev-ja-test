...
解析資料はNotequalsoftさんより情報提供して頂きました。具体的にはアーカイブ、スクリプト、画像、音声におけるデコードです。パッと見ただけで数か月か1年以上かかっていると思われる内容でした。GBA移植の出発地点を大きく変えてもらい、とても感謝しています。

- [Hoshi](https://twitter.com/hoshi903)

ゲームボーイサウンドでHoshiさんに音楽を作って頂きました。最初、どういう方向性でと悩んだ挙句「バブル時代のイケイケな感じで」という謎ワードが出てしまったのは今では笑い話です。打ち合わせの度にクオリティがアップしていて、特にエンディングは最高の出来栄えです。GBAは全体的に遅く味付けしたので音楽のbpmを遅くしています。良かったら[音楽ロム](https://github.com/akkera102/gbadev-ja-test/tree/main/126_viper_gts_bgm_test)も用意していますので聞いてみてください。
