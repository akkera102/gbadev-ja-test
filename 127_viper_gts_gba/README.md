...
メニュー表示時、セレクトボタンでフラグ変更可能です。メルセデスフラグは必須、カルラフラグは小話分岐となっています。
...
メニュー表示時、スタートボタンでスピーカーかヘッドフォンモードを選択できます。DMG音源のch3に対してのみ働きかける機能で、ドラムなどの音色が変わります。お好みで使用してください。
