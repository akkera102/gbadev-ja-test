...
- テキストの表示は横向き固定です
- 追加シナリオは最初から解放されています。青色しおりにはならない仕様です
- オリジナル画像を798x532にクリッピングし、3.325で割って240x160に縮小しています
- ゲーム開始時に攻略情報を使用するかどうかを選択できます
- 既読スキップは、STARTボタンで「高速スキップ」、SELECTボタンで「画面スキップ」が可能です
- 全ハッピーエンド達成後は、バッドルートに入っても全ハッピーエンドに固定されますのでご了承ください
- オススメの攻略順は「雨音→悠夏→藍→明日菜→文乃」です
- プレイ時間の目安は20～25時間です
- セーブデータはSRAMのみ対応しています
- 感想や不具合などありましたら[ご一報](https://akkera102.hatenablog.com/)ください
