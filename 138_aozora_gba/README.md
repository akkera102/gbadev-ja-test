# 果てしなく青い、この空の下で…。 for GBA（Work In Progress）
...
・メモリアル版
  ...
  AOZORAフォルダ内に「track」フォルダを作り、CDDAをリッピングして
  「track_02.wav」を配置します。
```
作業が完了すると、以下の構成になります。
```
...
- 追加シナリオはあらかじめ解放済みです。青色しおりにならない作りになっています
- 攻略情報を入れました。ゲーム開始時に選択できます
- 既読機能はスタートボタンで高速スキップ、セレクトボタンで画面スキップできます
- 全ヒロインハッピー済でバッドシナリオでも、全ハッピーエンディングに進みます。ご了承ください。
