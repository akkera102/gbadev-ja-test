...
作りはGTSのものを流用している為、代り映えのない操作方法となっています。

- 画質リサイズ1/2で256色を採用しています。いつもの通りガビガビです（汗
- 縦スクロール移動中でもアニメーションするように修正しました
- 容量に余裕があったので音声を10512Hzから16384Hzに変更しました
- 場面ジャンプのほかに、バトル中にのみ機能する自動勝ち負け機能を加えました
- 全ルートのプレイ時間は1時間程度です。もっと短いかもしれません
...
セレクトボタンにてフラグ変更可能です。フラグと場面の組み合わせによってはバグが発生し、回避のために値を強制変更しました。
