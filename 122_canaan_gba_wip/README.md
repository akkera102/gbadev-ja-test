...
hoshiさんに作って頂きました。GB音源でFM音源を再現してもらう無茶ぶりに快く承諾して頂いて大変助かっています。ネタで作ってもらったGBA起動時の音には思わずニヤリとなるでしょう。落下音、ドスン音もお気に入りです。効果音のみのテストロムも用意していますので参考にされる方は[こちら](https://github.com/akkera102/gbadev-ja-test/tree/main/123_nisfx_gpsg)をご覧ください。
