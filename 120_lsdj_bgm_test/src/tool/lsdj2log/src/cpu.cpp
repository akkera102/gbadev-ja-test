...
while (ScrCycle <= 0) {
	switch(vram_mode) {
		case 0: /* end of hblank */
			CURLINE++;
			if((CURLINE % 25) == 0 && CURLINE <= 150) Infogb_gba_savelog(0x61);
