...
無謀にもmode3アルファブレンドエフェクトを使っているため、一部でお見苦しい点もあるかと思います。

- 640x480サイズを4ドット削って636x480。3で割って212x160にしています。GBAのフルサイズは240x160なので左右に黒帯がつきます
- オートセーブ機能はない為、手動保存した内容が最新扱いになります
...
- スタッフロールは縮小して文字が見えなくなるので泣く泣く見送りました
